    ...
    if(line.find('- name')!=-1):
        ...
        if(name==1): #hit name line
            if(line.find('hosts')!=-1): #not task
                ...
                print(line.rstrip())
                # print('line2:'+line)
                task_name_w_yml='post_query_'+task_name+'.yml'
            ...
            elif (task_name=='') and (task_type==1): #task=aci_rest, task name UNKNOWN
                if(line.find('": {')!=-1): #find=target_name
                    ...
                    print(task_name)
                    task_name_w_yml='post_query_'+line.split('"')[1]+'.yml'
                    file_new=open(task_name_w_yml, 'w')
                ...
                if(line.find(':')==-1):
                    ...
                    file_new.writelines('      success_msg: "Object exists in the Fabric."'+'\n')
                    file_new.writelines('      fail_msg: "Object does NOT exist in the Fabric."'+'\n')
                ...
                if line.find('# the end')!=-1:
                    ...
                    file_new.writelines('      success_msg: "Object exists under the tenant."'+'\n')
                    file_new.writelines('      fail_msg: "Object does NOT exist."'+'\n')
                    file_new.writelines('    with_items: "{{query_result.results}}"\n')
